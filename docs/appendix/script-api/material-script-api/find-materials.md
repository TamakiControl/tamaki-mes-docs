---
title: "findMaterials"
description: "Retrieves Materials based on the specified pagination, sort, and column constraint parameters."
sidebar_position: 0
---
...
Retrieves [Materials](../../data-model/material-model/material.md) based on the specified pagination, sort, and column constraint parameters.
...
|-----------------------------------------------------------------| ------------- | ---------------------------------------------------------------------------------------------------------------- |
| List\<[Material](../../data-model/material-model/material.md)> | content       | The list of all records found that meet the specified criteria                                                   |
