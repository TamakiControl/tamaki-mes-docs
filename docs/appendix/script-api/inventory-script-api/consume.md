...
| `consumingMaterialIdOrPath`   | `String`        | True     | The ID or path of the consuming lot's material.                                                                                           |
...
consumptionLotRecord = system.mes.inventory.consume(**newRequest)

# Output the JSON representation of the lot record of the consumption
print(consumptionLotRecord)
```
