...
| `destinationLotIdOrName`      | `String`        | True     | The id or name of the lot being shipped into.                                                                                             |
| `destinationMaterialIdOrPath` | `String`        | True     | The id or path of the material for the destination lot.                                                                                   |
| `destinationLocationIdOrPath` | `String`        | True     | The ID or path of the location that the inventory will be shipped into.                                                                   |
...
# Ship the inventory
shipmentLotRecord = system.mes.inventory.ship(**newRequest)

# Output the JSON representation of the lot record of the shipment
print(shipmentLotRecord)
```
