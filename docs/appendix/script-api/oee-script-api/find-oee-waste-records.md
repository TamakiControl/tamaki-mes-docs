---
sidebar_position: 48
title: "findOeeWasteRecords"
description: "Retrieves OEE waste records based on the specified pagination, sort, and column constraint parameters."
---
...
Retrieves [OEE Waste Records](../../data-model/oee-model/oee-waste-record) based on the specified pagination, sort, and column constraint parameters.
...
Using Python keyword arguments, a [Query Request](../query-script-api/new-query-request) can be passed to the `findOeeWasteRecords` function
...
|-----------------|-------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
| `content`       | `List`&lt;[OeeWasteRecord](../../data-model/oee-model/oee-waste-record)&gt;   | The list of all records found that meet the specified criteria                                                   |
...
Here is an example of how to use a Query Request to retrieve the first ten OEE waste records created in 2025, sorted
by start date.
