...
Creates or updates an OEE Availability Reason record in the system. To create a new availability reason, first generate a new object with [`system.mes.oee.newAvailabilityReason`](./new-availability-reason).
