---
sidebar_position: 39
title: 'getAllQualityReasonPathsByLocation'
description: 'Retrieves all quality reason paths for a specific location as a list of full hierarchical path strings.'
---
...
Retrieves the full hierarchical path for all OEE Quality Reasons configured for a specific location. This method
returns a simple list of strings, where each string is the complete path of a quality reason.
