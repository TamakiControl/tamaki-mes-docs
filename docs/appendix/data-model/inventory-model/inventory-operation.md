...
| `stop_trigger_expression`             | `String`        | Ignition expression to trigger the end of the transfer of materials.                                                                                       | See [Ignition Docs](https://www.docs.inductiveautomation.com/docs/8.1/platform/expression-language-and-syntax) |
...
| `inventory_name_expression`           | `String`        | The Ignition expression to specify the inventory name.                                                                                                     | See [Ignition Docs](https://www.docs.inductiveautomation.com/docs/8.1/platform/expression-language-and-syntax) |
