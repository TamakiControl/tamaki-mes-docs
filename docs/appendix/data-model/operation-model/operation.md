...
| `expected_duration_expression`             | `String`            | The Ignition expression for expected duration of an operation.                                                                                | ``                                            |  
...
| `start_trigger_expression`                 | `String` (max 2048) | Trigger Ignition expression when starting the operation.                                                                                      | ``                                            |
...
| `stop_trigger_expression`                  | `String` (max 2048) | Trigger Ignition expression when stopping the operation.                                                                                      | ``                                            |
