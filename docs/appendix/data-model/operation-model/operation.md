...
| `start_trigger_expression`                | `String`        | Trigger Ignition expression when starting the operation.                                                                                      | See [Ignition Docs](https://www.docs.inductiveautomation.com/docs/8.1/platform/expression-language-and-syntax) |
...
| `stop_trigger_expression`                 | `String`        | Trigger Ignition expression when stopping the operation.                                                                                      | See [Ignition Docs](https://www.docs.inductiveautomation.com/docs/8.1/platform/expression-language-and-syntax) |
