...
The OEE downtime table widget displays a table of recent downtime events for a specified location and availability reason.
...
- **Availability Reason**: The availability reason to display events for.
