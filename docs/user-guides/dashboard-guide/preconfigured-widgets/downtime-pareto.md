---
sidebar_position: 7
title: "Downtime Pareto Widget"
description: "Overview of the downtime pareto widget"
---
...
that have occurred recently for a specified location and availability reason. A Pareto chart is a type of chart that 
contains both bars and a line graph.

![downtime_pareto_widget.png](../../../../static/img/docs/user-guides/dashboard-guide/preconfigured-widgets/downtime_pareto_widget.png)
...
- **Availability Reason**: The availability reason parent to display events for.
